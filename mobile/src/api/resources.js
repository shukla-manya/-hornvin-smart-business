...
export const garageApi = {
  ...
  inventoryReorderMessage: () => api.get("/garage/inventory/reorder-message"),
  ...
  customerAutomatedMessage: (customerId) => api.get(`/garage/customers/${customerId}/automated-message`),
  vehiclesList: (customerId) => api.get(`/garage/customers/${customerId}/vehicles`),
  vehicleCreate: (customerId, body) => api.post(`/garage/customers/${customerId}/vehicles`, body),
  vehiclePatch: (id, body) => api.patch(`/garage/vehicles/${id}`, body),
  vehicleDelete: (id) => api.delete(`/garage/vehicles/${id}`),
  estimatesList: () => api.get("/garage/estimates"),
  estimateCreate: (body) => api.post("/garage/estimates", body),
  estimatePatch: (id, body) => api.patch(`/garage/estimates/${id}`, body),
  estimateConvertInvoice: (id) => api.post(`/garage/estimates/${id}/convert-invoice`),
  shopInvoicesList: () => api.get("/garage/shop-invoices"),
  shopInvoicePatchPayment: (id, body) => api.patch(`/garage/shop-invoices/${id}/payment-status`, body),
  shopInvoiceShare: (id) => api.get(`/garage/shop-invoices/${id}/share`),
